...
import 'package:takk/presentation/pages/address/viewmodel/address_viewmodel.dart';
...
class AddressPage extends ViewModelBuilderWidget<AddressViewModel> {
  AddressPage(this.cafeLocation, this.maxRadius, this.instruction);
  ...
  void onViewModelReady(AddressViewModel viewModel) {
    ...
    viewModel
        .reverseGeocodeLatLng(tag)
        .then((value) => viewModel.addMarker(tag: tag, locationResult: value));
          ...
          GoogleMap(
            ...
            initialCameraPosition: CameraPosition(
              target: viewModel.currentPosition ??
                  const LatLng(40.703504, -74.016594),
              zoom: 15,
            ),
            ...
            onCameraIdle: () {
              viewModel.funcCameraIdleMove(
                  tag: tag, mapController: _controller);
            },
          ),
          Positioned(
            bottom: 15,
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          viewModel.locationResult != null
                              ? viewModel.locationResult!.address ??
                                  'Unknown address'
                              : 'Unknown address',
                      ...
                      itemBuilder: (context, index) =>
                          floatingSearchBarController.query.isEmpty
                              ? ListTile(
                                  ...
                                  onTap: () {
                                    viewModel.funcUserAddressItem1(
                                        index,
                                        floatingSearchBarController,
                                        _controller);
                                  },
                                  title: Text(
                                    viewModel
                                            .listUserAddresses[index].address ??
                                        'Unknown address',
                              ...
                              : ListTile(
                                  contentPadding:
                                      const EdgeInsets.only(left: 15),
                                  onTap: () {
                                    viewModel.funcUserAddressItem2(
                                        tag,
                                        index,
                                        _controller,
                                        floatingSearchBarController);
                                  ...
                                  title: Text(
                                    viewModel.completeAddresses[index].text ??
                                        'Unknown address',
                                    style: AppTextStyles.body14w6,
                                  ),
                                  trailing: IconButton(
