...
class LatestOrdersViewModel extends BaseViewModel {
  ...
  Future<void> getUserOrder(String tag) async {
    safeBlock(() async {
      ...
      setSuccess(tag: tag);
    }, callFuncName: 'getUserOrder', inProgress: false);
  }
  ...
  Future<void> setFavorite(String tag, var modelCart) async {
    ...
    notifyListeners();
    setOrderLike(
            tag, modelCart.id, modelCart.like == null ? true : !modelCart.like!)
        .then((value) {});
  }

  Future<void> showAddFavorite(
      String tagAddToCart, String tagSetCartFov, var modelCart) async {
