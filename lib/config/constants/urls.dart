class Url {
  ...
  static getCompList(int? pageSize) => Uri.parse(
      '$baseUrl/companies/${pageSize != null ? "?page_size=$pageSize" : ""}');

  static getMessages(int? pageSize) => Uri.parse(
      '$baseUrl/ws-chat/${pageSize != null ? "?page_size=$pageSize" : ""}');
  ...
  static getCompanyInfoForChat(int id) =>
      Uri.parse('$baseUrl/ws-chat/companies/$id/');
  ...
  static var changeStatusProduct =
      Uri.parse('$baseUrl/employees/cafes/product-available/');
