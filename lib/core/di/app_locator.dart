...
import 'package:takk/data/repositories/fav_ordered_repository_impl.dart';
...
void setupLocator() {
  ...
  locator.registerLazySingleton<FavOrderedRepository>(() => FavOrderedRepositoryImpl(locator.get()));
}
